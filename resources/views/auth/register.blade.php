...
<div class="container">
    ...
    <form id="login-form"class="login-form" method="post" action="{{ route('register') }}">
        ...
        <div class="login-wrap">
            ...
            <button id="signup-button" class="btn btn-info btn-lg btn-block" >Signup</button>
            <br>
            <a href="{{ route('login') }}" id="login-button" class="btn btn-primary btn-lg btn-block" type="submit">Login</a>
