                    ...
                    <div class="row">
                        <div class="col-lg-8 task-progress pull-left">
                            <span class="pull-left">
                                        <img style="width : 50px; height: auto;" class="simple" src="{{url('imagecache/small/'. $tab_users[''. $event->id .'']['photo'])}}">
            ...
            <section class="panel col-lg-offset-2 col-lg-8">
                <div class="panel-body progress-panel">
                    <div class="row">
                        <div class="col-lg-8 task-progress pull-left">
                            <span class="pull-left">
                                        <img style="width : 50px; height: auto;" class="simple" src="{{url('imagecache/small/'. $tab_users[''. $ad->id .'']['photo'])}}">
